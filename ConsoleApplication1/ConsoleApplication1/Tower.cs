...
namespace ConsoleApplication1
{
    class Tower:IEnumerable
    {
        ...
        public Tower(Backpack pack,Party party)
        {
            ...
            Level level1= new CombatLevel(new RobinHood(), new KingRichard(),1,party);
            Level level2 = new CombatLevel(new Mulan(), new Shanyu(), 1, party);
            ...
            Level level5=new CombatLevel(new Simba(),new Scar(),1,party);
            ...
            Level level7=new CombatLevel(new MrIncerdible(),new Syndrome(),1,party);
            Level level8=new CombatLevel(new Hercules(),new Hades(),1,party);
            Level level9=new LevelWithItems(new Mike(),new Randal(),new String[]{"Doll","Door","Door","Door","Scream","Scream"},new String[]{"Doll","Door","Sream","Scream"},pack);
